...
@section('head')
	<title>Factura {{ $expense->code }}</title>
	@csss(
		...
		<div class="col-12">
			<form class="data-validation editObjectForm" method="post" onSubmit="return false;">
				...
				<div class="input-icon input-group right mb-2">
					...
					<select class="form-control select2" data-api="invoices" data-object-id="{{$expense->id}}" id="invoice[company_id]" name="invoice[company_id]">
			...
			<table class="table table-bordered table-hover table-checkable">
				...
				<tbody>
					<tr>
						...
						<td>{{ $expense->company->vat->translation->name }}</td>
